...
# 5.times do
#   Passenger.create(name: Faker::Name.name, email: Faker::Internet.email, password: Faker::Internet::password(8), phone_number: Faker::PhoneNumber.phone_number)
# end

# 5.times do
#   Driver.create(name: Faker::Name.name, email: Faker::Internet.email, password: Faker::Internet::password(8), phone_number: Faker::PhoneNumber.phone_number)
# end
